def crawlViettelStore():
    ...
    Devices = ["samsung", "apple-iphone", "oppo", "xiaomi", "vivo", "realme", "nokia", "itel", "philips", "zte", "masstel"]
    ID = 1
    for i in range(len(Devices)):
        URL = 'https://www.viettelstore.vn/dtdd-' + Devices[i]
        headers = {
        ...
        data = soup.find('div', {"id": "div_Danh_Sach_San_Pham"})
        print(data)
